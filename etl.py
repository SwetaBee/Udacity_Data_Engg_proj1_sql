...
def process_song_file(cur, filepath):
    ...
    * filepath the file path to the song file
    ...
    OUTPUTS:
    * Update song_table and artist_table
    """
...
def process_log_file(cur, filepath):
    ...
    * filepath the file path to the song file
    ...
    OUTPUTS:
    * Update time_table, user_table and songplay_table
    """
...
def process_data(cur, conn, filepath, func):
    ...
    * filepath the file path to the song file
    * func is process_song_file and process_log_file
...
def main():
    """     
     ...
     - calling process_data functions to process all the files in song_data and log_data and 
         generate the lists for INSERT tables     
     """
